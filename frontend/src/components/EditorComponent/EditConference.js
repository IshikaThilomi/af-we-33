...
class EditConference extends Component {
    ...
    onSubmit(e) {
        ...
        axios.put('https://afwe3.herokuapp.com/conference/editconference', Conference)
            ...
            toast.show({title: 'Conference Details Updated', position: 'topright', type: 'info'})
    }

    componentDidMount() {
        axios.get(`https://afwe3.herokuapp.com/conference/get_conferences_byid/${this.props.match.params.id}`)
            .then(response => {
    ...
    render() {
        return (
            ...
            <img src={process.env.PUBLIC_URL+"/reimage.jpg"}/>
                                ...
                                <center> <h3 className="mainclass">Edit Conference</h3></center>
                                <form onSubmit={this.onSubmit}>
                                    ...
                                    <div className="form-group">
                                        <input type="submit" value="Edit Conference Details" className="btn btn-primary" />
                                    </div>
                                </form>

...
class PendingConferences extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://afwe3.herokuapp.com/reviewer/get_all_pending_presentations')
            .then(response => {
    ...
    navigateSubjectPage(e, ID) {
        window.location = `/manage_presenations/${ID}`
    }
    ...
    render() {
        return (
            ...
            <div className="container">
                <br></br>
                <center> <h3 className="mainclass">Pending Presentations</h3></center>
                <MDBContainer>

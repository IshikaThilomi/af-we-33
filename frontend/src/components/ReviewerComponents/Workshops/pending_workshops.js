...
class PendingConferences extends Component {
    ...
    componentDidMount() {
        console.log("test")
        axios.get('https://afwe3.herokuapp.com/reviewer/get_all_pending_workshops')
            .then(response => {
    ...
    navigateSubjectPage(e, ID) {
        window.location = `/manage_workshops/${ID}`
    }
    ...
    render() {
        return (
            ...
            <div className="container">
                <br></br>
                <center> <h3 className="mainclass">Pending Workshops</h3></center>
                <MDBContainer>

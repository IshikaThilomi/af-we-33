...
class PendingConferences extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://afwe3.herokuapp.com/reviewer/get_all_pending_reseach_pappers')
            .then(response => {
    ...
    navigateSubjectPage(e, ID) {
        window.location = `/manage_research/${ID}`
    }
    ...
    render() {
        return (
            ...
            <div className="container">
                <br></br>
                <center> <h3 className="mainclass"> Pending Research Papper</h3></center>
                <MDBContainer>

              ...
              <MDBCol md="15">
               ...
               <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <input onClick={e => this.OnAccept(e)} value="Approve Research " className="btn btn-primary" />
                    </div>
                    <br></br>
                    <div className="form-group">
                        <input onClick={e => this.OnDecline(e)} value="Decline Research " className="btn btn-primary" />
                    </div>
                </form>

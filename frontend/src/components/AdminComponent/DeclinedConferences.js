...
class PendingConferences extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://afwe3.herokuapp.com/adminconference/get_all_declined_conferences')
            .then(response => {
    ...
    navigateSubjectPage(e, ID) {
        window.location = `/get_conference_by_idx/${ID}`
    }
    ...
    render() {
        return (
            ...
            <div className="container">
                <br></br>
                <center> <h3 className="mainclass">Declined Conferences</h3></center>
                <MDBContainer>

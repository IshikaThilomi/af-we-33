...
class PendingConferences extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://afwe3.herokuapp.com/adminconference/get_all_approved_Conferences')
            .then(response => {
    ...
    navigateSubjectPage(e, ID) {
        window.location = `/get_conference_by_idy/${ID}`
    }
    ...
    render() {
        return (
            ...
            <div className="container">
                <br></br>
                <center> <h3 className="mainclass">Approved Conferences</h3></center>
                <MDBContainer>
                                ...
                                <div key={index} className="card mb-3">
                                    <div className="p-3" >
                                        ...
                                        <div className="form-group">
                                            <input type="submit" onClick={e => this.navigateSubjectPage(e, item._id)}  value="View Change Request" className="btn btn-primary" />
                                        </div>
                                    </div>
